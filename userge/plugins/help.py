...
REPO_X = InlineQueryResultArticle(
    title="Repo",
    input_message_content=InputTextMessageContent("**Here's how to setup WILDYVPN-Bot** "),
    url="https://github.com/wildyvpnproject/botproject2",
    description="Setup Your Own",
    thumb_url="https://t.me/wildyvpn_channel/18",
    reply_markup=InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    "🔥 WILDYVPN-Bot Repo", url="https://github.com/wildyvpnproject/botproject2"
                ),
                InlineKeyboardButton(
                    "🚀 Deploy USERGE-X",
                    url=(
                        "https://heroku.com/deploy?template="
                        "https://github.com/wildyvpnproject/botproject2/"
                    ),
                ),
            ]
        ]
...
ALIVE_IMGS = [
    "https://t.me/wildyvpn_channel/18",
    "https://t.me/wildyvpn_channel/18",
    "https://t.me/wildyvpn_channel/18",
    "https://t.me/wildyvpn_channel/18",
    "https://t.me/wildyvpn_channel/18",
...
"""
            ...
            if str_x[0].lower() == "secret" and len(str_x) == 3:
                ...
                results.append(
                    InlineQueryResultArticle(
                        ...
                        thumb_url="https://t.me/wildyvpn_channel/18SS",
                        reply_markup=InlineKeyboardMarkup(buttons),
                    )
                )
            ...
            MAIN_MENU = InlineQueryResultArticle(
                title="Main Menu",
                input_message_content=InputTextMessageContent(" WILDYVPN-BOT MAIN MENU "),
                url="https://github.com/wildyvpnproject/botproject",
                description="WILDYVPN-BOT Main Menu",
                thumb_url="https://t.me/wildyvpn_channel/18",
                reply_markup=InlineKeyboardMarkup(main_menu_buttons()),
            )
